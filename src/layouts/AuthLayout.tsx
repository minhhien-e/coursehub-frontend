...
export const AuthLayout = () => {
  return (
    <div className="min-h-screen flex w-full bg-background text-textMain">
      {/* Left Branding Panel (Hidden on Mobile) */}
      <div className="hidden lg:flex w-1/2 flex-col justify-center items-center bg-[#07130c] border-r border-borderDim p-12">
        ...
        <p className="text-textMuted text-center max-w-sm mb-16 leading-relaxed">
          The all-in-one learning platform to master new skills, earn certificates, and advance your career.
        </p>

        <div className="grid grid-cols-3 gap-8 text-center border-t border-borderDim pt-12">
          <div>
            <div className="text-2xl font-bold text-emerald-400 mb-1">342</div>
            <div className="text-xs text-textMuted">Courses</div>
          </div>
          <div>
            <div className="text-2xl font-bold text-emerald-400 mb-1">124K</div>
            <div className="text-xs text-textMuted">Students</div>
          </div>
          <div>
            <div className="text-2xl font-bold text-emerald-400 mb-1">98%</div>
            <div className="text-xs text-textMuted">Satisfaction</div>
          </div>
        </div>
      </div>
