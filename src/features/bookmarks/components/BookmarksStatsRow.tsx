  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 mb-8">
      ...
      <div className="bg-surfaceHighlight border border-borderDim rounded-xl p-5 flex justify-between items-start">
        <div>
          <p className="text-textMuted text-sm font-medium mb-1">Total Bookmarks</p>
      ...
      <div className="bg-surfaceHighlight border border-borderDim rounded-xl p-5 flex justify-between items-start">
        <div>
          <p className="text-textMuted text-sm font-medium mb-1">Courses Saved</p>
          <h3 className="text-2xl font-extrabold text-white mb-2">{stats.coursesSaved}</h3>
          <p className="text-xs font-medium text-textMuted">Across {stats.collections} categories</p>
        </div>
        <div className="w-10 h-10 rounded-xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center">
      ...
      <div className="bg-surfaceHighlight border border-borderDim rounded-xl p-5 flex justify-between items-start">
        <div>
          <p className="text-textMuted text-sm font-medium mb-1">Lessons Saved</p>
      ...
      <div className="bg-surfaceHighlight border border-borderDim rounded-xl p-5 flex justify-between items-start">
        <div>
          <p className="text-textMuted text-sm font-medium mb-1">Collections</p>
          <h3 className="text-2xl font-extrabold text-white mb-2">{stats.collections}</h3>
          <p className="text-xs font-medium text-textMuted">Favorites, Study Later, Exam Prep</p>
        </div>
        <div className="w-10 h-10 rounded-xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center">
