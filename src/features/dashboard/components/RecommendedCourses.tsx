...
export const RecommendedCourses = () => {
  return (
    <div className="bg-[#0a0e0c] border border-[#1b251e] rounded-xl overflow-hidden">
      ...
      <div className="divide-y divide-[#1b251e]">
        {courses.map(course => (
          <div key={course.id} className="p-5 flex gap-4 hover:bg-[#121814] transition-colors group cursor-pointer">
            <div className="w-24 h-16 rounded-lg overflow-hidden shrink-0 border border-[#1b251e]">
