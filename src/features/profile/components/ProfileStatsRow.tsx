...
export const ProfileStatsRow = () => {
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
      ...
      <div className="bg-surfaceHighlight border border-borderDim rounded-xl p-5 flex flex-col items-center justify-center text-center">
        <Book size={24} className="text-emerald-500 mb-2" />
        <h3 className="text-2xl font-extrabold text-white mb-1">3</h3>
        <p className="text-xs font-medium text-textMuted">Courses Enrolled</p>
      </div>

      <div className="bg-surfaceHighlight border border-borderDim rounded-xl p-5 flex flex-col items-center justify-center text-center">
        <Award size={24} className="text-emerald-500 mb-2" />
        <h3 className="text-2xl font-extrabold text-white mb-1">3</h3>
        <p className="text-xs font-medium text-textMuted">Certificates</p>
      </div>

      <div className="bg-surfaceHighlight border border-borderDim rounded-xl p-5 flex flex-col items-center justify-center text-center">
        <Trophy size={24} className="text-emerald-500 mb-2" />
        <h3 className="text-2xl font-extrabold text-white mb-1">7</h3>
        <p className="text-xs font-medium text-textMuted">Badges</p>
      </div>
      ...
      <div className="bg-surfaceHighlight border border-borderDim rounded-xl p-5 flex flex-col items-center justify-center text-center">
        ...
        <p className="text-xs font-medium text-textMuted">Day Streak</p>
      </div>
