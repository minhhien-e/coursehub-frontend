...
export const LessonSidebar = ({ course, activeLessonId, onSelectLesson }: LessonSidebarProps) => {
  return (
    <div className="h-full flex flex-col bg-[#0d120f] border-l border-[#1b251e]">
      <div className="p-4 border-b border-[#1b251e]">
                  ...
                  >
                    <div className="mt-0.5 shrink-0">
                      {isCompleted ? (
                        ...
                        <PlayCircle size={16} className={isActive ? "text-emerald-400" : "text-zinc-500"} />
                      )}
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                      <span className={cn(
                        ...
                        isActive ? "text-emerald-400" : (isCompleted ? "text-zinc-300" : "text-zinc-400")
                      )}>
                        {lesson.title}
                      </span>
