...
export const CertificateCard = ({ certificate }: CertificateCardProps) => {
  return (
    <div className="bg-[#0a0e0c] border border-[#1b251e] rounded-xl overflow-hidden flex flex-col hover:border-zinc-700 transition-colors">
      ...
      <div className="p-8 pb-10 flex flex-col items-center text-center relative overflow-hidden">
        ...
        <p className="text-zinc-500 text-sm mb-4 relative z-10">This certifies that</p>
        
        <h2 className="text-3xl font-bold text-white mb-4 relative z-10">
          {certificate.studentName}
        </h2>
        
        <p className="text-zinc-500 text-sm mb-2 relative z-10">has completed</p>
      ...
      {/* Divider */}
      <div className="w-full h-px bg-[#1b251e]" />

      {/* Bottom Section */}
      <div className="p-6 bg-[#0a0e0c] flex-1 flex flex-col justify-between">
        ...
        <div className="flex items-center gap-2 mt-auto">
          <button className="w-9 h-9 rounded-lg bg-[#121814] border border-[#1b251e] hover:bg-zinc-800 text-zinc-400 hover:text-white flex items-center justify-center transition-colors">
            <Download size={16} />
          </button>
          <button className="w-9 h-9 rounded-lg bg-[#121814] border border-[#1b251e] hover:bg-zinc-800 text-zinc-400 hover:text-white flex items-center justify-center transition-colors">
            <Share2 size={16} />
